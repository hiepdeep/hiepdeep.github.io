...
function cropImage() {
	...
	const txt_uploadError = document.getElementById("upload-image-error");
	const croperBox = document.getElementById("croper-box");
	const btnSave = document.getElementById("croper-box-save-image");
	...
	canvasImage.width = document.body.getBoundingClientRect().width;
	canvasImage.height = document.body.getBoundingClientRect().height;
			...
			reader.onload = function(event) {
				...
				img.onload = function() {
					...
					uploadedImage.onload = function() {
						const maxWidth = canvasImage.width;
						const maxHeight = canvasImage.height;
